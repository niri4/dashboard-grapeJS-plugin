...
1. Replace in all files `msc_plugin` with your plugin name
...
* CDN
  * `https://unpkg.com/msc_plugin`
* NPM
  * `npm i msc_plugin`
* GIT
  * `git clone https://github.com/YOUR-NAME/msc_plugin.git`
...
<script src="path/to/msc_plugin.min.js"></script>
